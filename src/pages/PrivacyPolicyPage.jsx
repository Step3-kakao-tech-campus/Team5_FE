    ...
    <>
      ...
      <div className="p-[10px]">
        <p>
          ...
          <br />
          &lt; 순수웨딩 &gt;('https://sunsu.user-app.krampoline.com'이하
          '순수웨딩')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고
          ...
          보유근거 : 홈페이지 관리자 페이지
          <br />
          관련법령 : 1)대금결제 및 재화 등의 공급에 관한 기록 : 5년 2) 소비자의
          불만 또는 분쟁처리에 관한 기록 : 3년
          <br />
          예외사유 :
          <br />
          <br />
          제3조(처리하는 개인정보의 항목)① &lt; 순수웨딩 &gt;은(는) 다음의
          개인정보 항목을 처리하고 있습니다.
          <br />
          1&lt; 홈페이지 회원가입 및 관리 &gt;
          <br />
          필수항목 : 이름, 로그인ID, 비밀번호, 이메일, 결제기록, 접속 IP 정보,
          쿠키, 접속 로그, 서비스 이용 기록
          <br />
          <br />
          ...
          순수웨딩 &gt; 의 개인정보 보호책임자의 승인을 받아 개인정보를
          파기합니다.
          <br />
          2. 파기방법
          <br />
          ...
          <br />
          &lt; 순수웨딩 &gt;은(는) 개인정보의 안전성 확보를 위해 다음과 같은
          조치를 취하고 있습니다.
          <br />
          ...
          사용하고 있습니다.
          <br />
          5. 문서보안을 위한 잠금장치 사용개인정보가 포함된 서류, 보조저장매체
          ...
          <br />
          ① 순수웨딩 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고,
          ...
          연락처 :
          <br />
          ② 정보주체께서는 순수웨딩 의 서비스(또는 사업)을 이용하시면서 발생한
          모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
          개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 순수웨딩
