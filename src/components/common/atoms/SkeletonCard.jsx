      ...
      <div className="animate-pulse">
        ...
        <div className="py-[9px] px-[8px]">
          <div className="flex whitespace-nowrap">
            <div className="inline bg-lightgray-sunsu h-[14px] w-[80px] mr-auto" />
            <div className="inline bg-lightgray-sunsu h-[14px] w-[22px]" />
          </div>
          <div className="bg-lightgray-sunsu h-[31px] mt-[3px] w-full" />
