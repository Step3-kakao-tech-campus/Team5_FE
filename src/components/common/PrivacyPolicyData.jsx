const PrivacyPolicyData = () => {
  return (
    <p>
      &lt; 순수웨딩 &gt;(&apos;https://sunsu.user-app.krampoline.com&apos;이하
      &apos;순수웨딩&apos;)은(는) 「개인정보 보호법」 제30조에 따라 정보주체의
      ...
      <br />
      &lt; 순수웨딩 &gt;(&apos;https://sunsu.user-app.krampoline.com&apos;이하
      &apos;순수웨딩&apos;)은(는) 다음의 목적을 위하여 개인정보를 처리합니다.
      ...
      1. 홈페이지 회원가입 및 관리
      <br />
      회원 가입의사 확인, 회원자격 유지·관리, 서비스 부정이용 방지 목적으로
      개인정보를 처리합니다.
      <br />
      <br />
      2. 재화 또는 서비스 제공
      <br />
      서비스 제공, 콘텐츠 제공, 맞춤서비스 제공, 요금결제·정산을 목적으로
      개인정보를 처리합니다.
      <br />
      <br />
      3. 마케팅 및 광고에의 활용
      ...
      <br />
      ① &lt; 순수웨딩 &gt;은(는) 법령에 따른 개인정보 보유·이용기간 또는
      ...
      보유근거 : 홈페이지 관리자 페이지
      <br />
      관련법령 : 1)대금결제 및 재화 등의 공급에 관한 기록 : 5년 2) 소비자의 불만
      또는 분쟁처리에 관한 기록 : 3년
      <br />
      예외사유 :
      <br />
      <br />
      제3조(처리하는 개인정보의 항목)① &lt; 순수웨딩 &gt;은(는) 다음의 개인정보
      항목을 처리하고 있습니다.
      <br />
      1&lt; 홈페이지 회원가입 및 관리 &gt;
      <br />
      필수항목 : 이름, 로그인ID, 비밀번호, 이메일, 결제기록, 접속 IP 정보, 쿠키,
      접속 로그, 서비스 이용 기록
      <br />
      <br />
      제4조(개인정보의 파기절차 및 파기방법)
      <br />
      ① &lt; 순수웨딩 &gt; 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
      ...
      1. 파기절차
      <br />
      &lt; 순수웨딩 &gt; 은(는) 파기 사유가 발생한 개인정보를 선정하고, &lt;
      순수웨딩 &gt; 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
      <br />
      2. 파기방법
      <br />
      ...
      <br />
      ① 정보주체는 순수웨딩에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
      요구 등의 권리를 행사할 수 있습니다.
      <br />
      ② 제1항에 따른 권리 행사는순수웨딩에 대해 「개인정보 보호법」 시행령
      제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
      있으며 순수웨딩은(는) 이에 대해 지체 없이 조치하겠습니다.
      <br />
      ...
      <br />
      ⑥ 순수웨딩은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
      ...
      <br />
      &lt; 순수웨딩 &gt;은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를
      취하고 있습니다.
      <br />
      ...
      있습니다.
      <br />
      2. 개인정보에 대한 접근 제한개인정보를 처리하는 데이터베이스시스템에 대한
      접근권한의 부여,변경,말소를 통하여 개인정보에 대한 접근통제를 위하여
      필요한 조치를 하고 있으며 침입차단시스템을 이용하여 외부로부터의 무단
      접근을 통제하고 있습니다.
      <br />
      3. 접속기록의 보관 및 위변조 방지개인정보처리시스템에 접속한 기록을 최소
      1년 이상 보관, 관리하고 있으며,다만, 5만명 이상의 정보주체에 관하여
      개인정보를 추가하거나, 고유식별정보 또는 민감정보를 처리하는 경우에는
      2년이상 보관, 관리하고 있습니다.또한, 접속기록이 위변조 및 도난, 분실되지
      않도록 보안기능을 사용하고 있습니다.
      <br />
      4. 개인정보의 암호화이용자의 개인정보는 비밀번호는 암호화 되어 저장 및
      관리되고 있어, 본인만이 알 수 있으며 중요한 데이터는 파일 및 전송 데이터를
      암호화 하거나 파일 잠금 기능을 사용하는 등의 별도 보안기능을 사용하고
      있습니다.
      <br />
      5. 문서보안을 위한 잠금장치 사용개인정보가 포함된 서류, 보조저장매체 등을
      ...
      사항)
      <br />
      ① 순수웨딩 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
      ...
      <br />
      &lt; 순수웨딩 &gt;은(는) 온라인 맞춤형 광고 등을 위한 행태정보를
      수집·이용·제공하지 않습니다.
      <br />
      <br />
      제9조(추가적인 이용·제공 판단기준)
      <br />
      &lt; 순수웨딩 &gt; 은(는) ｢개인정보 보호법｣ 제15조제3항 및 제17조제4항에
      따라 ｢개인정보 보호법 시행령｣ 제14조의2에 따른 사항을 고려하여 정보주체의
      동의 없이 개인정보를 추가적으로 이용·제공할 수 있습니다. 이에 따라 &lt;
      순수웨딩 &gt; 가(이) 정보주체의 동의 없이 추가적인 이용·제공을 하기 위해서
      다음과 같은 사항을 고려하였습니다.
      <br />
      ...
      <br />
      ① 순수웨딩 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
      ...
      연락처 :
      <br />
      ② 정보주체께서는 순수웨딩 의 서비스(또는 사업)을 이용하시면서 발생한 모든
      개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보
      보호책임자 및 담당부서로 문의하실 수 있습니다. 순수웨딩 은(는) 정보주체의
      ...
      <br />
      제12조(개인정보 처리방침 변경)
      <br />① 이 개인정보처리방침은 2023년 9월 1일부터 적용됩니다.
    </p>
  );
};
